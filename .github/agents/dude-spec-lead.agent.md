...
2. Preserve the raw user draft, let the user answer open questions in place, maintain the Dude-owned sections yourself, and keep the file in `status: draft` until definition is requested.
